...
public class SearchForEmployeesByDepartmentService {
	...
	public List<EmployeeBean> execute(Integer deptId) {
		//EntityにdepIdフィールドがないためDepartment(deptId,DeptNameを代用
		Department department = new Department();
		//ListContorollerよりdeptIdを受け取る
		department.setDeptId(deptId);
		List<Employee> employeeList = repository.findByDepartmentOrderByEmpId(department);
